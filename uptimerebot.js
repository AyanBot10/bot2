...
const myMonitor = new Monitor({
    address: 'https://270c07a5-4308-4bf5-97ac-43e0db5c22cc-00-ni719hzqailk.teams.replit.dev',//change the ip address of the web to run the bot or leave 127.0.0.1 also known as localhost nha bruh( just for pro 🐧)
    port: 5000, //port bot 
    interval: 1, // 10 giây
  config: {
