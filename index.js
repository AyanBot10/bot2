...
monitor.on('up', (res) => console.log(chalk.bold.hex("#00FF00")("[ FAHEEM ] ❯ ") + chalk.hex("#00FF00")(`${res.website}`)))
...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "anup.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
axios.get("https://raw.githubusercontent.com/Anupx0/AliyaAnupVip/main/package.json").then((res) => {
...
app.get('/', (req, res) => res.sendFile(__dirname+'/aliya.html'))