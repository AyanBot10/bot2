...
module.exports.config = {
  ...
  description: "dad the user tagged",
  commandCategory: "general",
  usages: "dad [Tag someone you need to dad]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/dab').then(res => {
