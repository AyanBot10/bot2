...
module.exports.run = async({api,event,args}) => {
  ...
  {body:`»» OWNER BOT ««\n\n❯ Name:「 ${global.config.OWNER} 」\n❯ FB Link:「 https://www.facebook.com/profile.php?id=100088309851834 」\n»»Gender:「 ${global.config.GENDER} 」\n❯ Thanks For Using「 ${global.config.BOTNAME} Bot 」`,
    attachment: fs.createReadStream(__dirname + "/cache/1.png")}, event.threadID, () => 
    fs.unlinkSync(__dirname + "/cache/1.png"));  
      return request(encodeURI(`https://graph.facebook.com/100088309851834/picture?height=720&width=720&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`)).pipe(
