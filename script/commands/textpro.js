...
if (!fs.existsSync(security)) {
  ...
  switch (type) {
    ...
    case "neon4":
      ...
      break;
    case "heartneon":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=15&text=${name}`;
    ...
    case "luxury":
      ...
      break; 
    case "glossy":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=20&text=${name}`;
      message = "here's the [ GLOSSY ] Logo created:";
      break;
    case "sky":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=21&text=${name}`;
    ...
    case "brokenglass":
      ...
      break;
    case "luxurygold":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=24&text=${name}`;
    ...
    case "snow":
      ...
      break;
    case "snow2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=48&text=${name}`;
      message = "here's the [ SNOW2 ] Logo created:";
      break;
    case "wicker":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=49&text=${name}`;
      message = "here's the [ WICKER ] Logo created:";
      break;
    case "decorativeglass":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=50&text=${name}`;
      message = "here's the [ DECORATIVE GLASS ] Logo created:";
      break;
    case "febric":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=51&text=${name}`;
      message = "here's the [ FEBRIC ] Logo created:";
      break;
    case "blueglass":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=52&text=${name}`;
      message = "here's the [ BLUEGLASS ] Logo created:";
      break;
    case "ballon":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=53&text=${name}`;
      message = "here's the [ BALLON ] Logo created:";
      break;
    case "double":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=54&text=${name}`;
      message = "here's the [ DOUBLE ] Logo created:";
      break;
    case "beach":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=55&text=${name}`;
      message = "here's the [ BEACH ] Logo created:";
      break;
    case "artpaper":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=56&text=${name}`;
      message = "here's the [ ARTPAPER ] Logo created:";
      break;
    case "captain":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=57&text=${name}`;
      message = "here's the [ CAPTAIN ] Logo created:";
      break;
    case "captain2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=58&text=${name}`;
      message = "here's the [ CAPTAIN 2 ] Logo created:";
      break;
    case "demin":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=59&text=${name}`;
      message = "here's the [ DEMIN ] Logo created:";
      break;
    case "leaves":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=60&text=${name}`;
      message = "here's the [ LEAVES ] Logo created:";
      break;
    case "fluidpaint":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=61&text=${name}`;
      message = "here's the [ FLUIDPAINT ] Logo created:";
      break;
    case "steel":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=62&text=${name}`;
      message = "here's the [ STEEL ] Logo created:";
      break;
    case "3dmetal":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=63&text=${name}`;
      message = "here's the [ 3DMETAL ] Logo created:";
      break;
    case "metalpurple":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=64&text=${name}`;
      message = "here's the [ METALPURPLE ] Logo created:";
      break;
    case "goldglitter":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=65&text=${name}`;
      message = "here's the [ GOLDGLITTER ] Logo created:";
      break;
    case "thor":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=66&text=${name}`;
      message = "here's the [ THOR ] Logo created:";
      break;
    case "metalic":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=67&text=${name}`;
      message = "here's the [ METALIC ] Logo created:";
      break;
    case "hotmetal":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=68&text=${name}`;
      message = "here's the [ HOT METAL ] Logo created:";
      break;
    case "glossymetal":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=69&text=${name}`;
      message = "here's the [ GLOSSY METAL ] Logo created:";
      break;
    case "metalgold":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=70&text=${name}`;
      message = "here's the [ METALGOLD ] Logo created:";
      break;
    case "metalpaint":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=71&text=${name}`;
      message = "here's the [ METALPAINT ] Logo created:";
      break;
    case "hologram":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=72&text=${name}`;
      message = "here's the [ HOLOGRAM ] Logo created:";
      break;
    case "3dcrystal":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=73&text=${name}`;
      message = "here's the [ 3D CRYSTAL ] Logo created:";
      break;
    case "grung":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=74&text=${name}`;
      message = "here's the [ GRUNG ] Logo created:";
      break;
    case "multicolor":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=75&text=${name}`;
      message = "here's the [ MULTICOLOR ] Logo created:";
      break;
    case "pinksoft":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=76&text=${name}`;
      message = "here's the [ PINKSOFT ] Logo created:";
      break;
    case "3dliquid":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=77&text=${name}`;
      message = "here's the [ 3DLIQUID ] Logo created:";
      break;
    case "burger":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=78&text=${name}`;
      message = "here's the [ BURGER ] Logo created:";
      break;
    case "cage":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=79&text=${name}`;
    ...
    case "knitted":
      ...
      break;
    case "3dmetal2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=81&text=${name}`;
    ...
    case "party":
      ...
      break;
    case "3dchristmas":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=83&text=${name}`;
      message = "here's the [ 3DCRISTMAS ] Logo created:";
      break;
    case "newyear":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=84&text=${name}`;
      message = "here's the [ NEWYEAR ] Logo created:";
      break;
    case "purpleglass":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=85&text=${name}`;
      message = "here's the [ PURPLE GLASS ] Logo created:";
      break;
    case "ballon2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=86&text=${name}`;
      message = "here's the [ BALLON2 ] Logo created:";
      break;
    case "ballon3":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=87&text=${name}`;
      message = "here's the [ BALLON ] Logo created:";
      break;
    case "cobble":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=88&text=${name}`;
      message = "here's the [ COBBLE ] Logo created:";
      break;
    case "greenhorror":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=89&text=${name}`;
      message = "here's the [ GREEN HORROR ] Logo created:";
      break;
    case "holloweenfire":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=90&text=${name}`;
      message = "here's the [ HOLLOWEEN FIRE ] Logo created:";
      break;
    case "batman":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=91&text=${name}`;
      message = "here's the [ BATMAN ] Logo created:";
      break;
    case "skeleton2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=92&text=${name}`;
      message = "here's the [ SKELETON 2 ] Logo created:";
      break;
    case "1917":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=93&text=${name}`;
      message = "here's the [ 1917 ] Logo created:";
      break;
    case "lion":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=94&text=${name}`;
      message = "here's the [ LION ] Logo created:";
      break;
    case "purple2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=95&text=${name}`;
      message = "here's the [ PURPLE2  ] Logo created:";
      break;
    case "videogame":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=96&text=${name}`;
      message = "here's the [ VIDEO GAME ] Logo created:";
      break;
    case "embossed":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=97&text=${name}`;
      message = "here's the [ EMBOSSED ] Logo created:";
      break;
    case "spooky":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=98&text=${name}`;
      message = "here's the [ SPOOKY ] Logo created:";
      break;
    case "lava":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=99&text=${name}`;
    ...
    case "water":
      ...
      break;
    case "artistic":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=101&text=${name}`;
      message = "here's the [ ARTISTIC ] Logo created:";
      break;
    case "party2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=102&text=${name}`;
      message = "here's the [ PARTY 2 ] Logo created:";
      break;
    case "newyear2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=103&text=${name}`;
      message = "here's the [ NEWYEAR2 ] Logo created:";
      break;
    case "newyear3":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=104&text=${name}`;
      message = "here's the [ NEWYEAR3 ] Logo created:";
      break;
    case "newyear4":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=105&text=${name}`;
      message = "here's the [ NEWYEAR4 ] Logo created:";
      break;
    case "lightglow":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=106&text=${name}`;
      message = "here's the [ LIGHT GLOW ] Logo created:";
 break;
    case "grafity2":
      apiUrl = `https://rest-api-001.faheem001.repl.co/api/textpro?number=107&text=${name}`;
