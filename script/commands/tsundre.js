...
module.exports.config = {
  ...
  description: "tsundre the user tagged",
  commandCategory: "general",
  usages: "tsundre [Tag someone you need to tsundre]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/tsundre').then(res => {
