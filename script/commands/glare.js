...
module.exports.config = {
  ...
  description: "glare the user tagged",
  commandCategory: "general",
  usages: "glare [Tag someone you need to glare]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/glare').then(res => {
