...
module.exports.config = {
  ...
  description: "yandere the user tagged",
  commandCategory: "general",
  usages: "yandere [Tag someone you need to yandere]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/yandere').then(res => {
