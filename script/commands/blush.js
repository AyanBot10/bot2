...
module.exports.config = {
  ...
  description: "blush the user tagged",
  commandCategory: "general",
  usages: "blush [Tag someone you need to blush]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/blush').then(res => {
