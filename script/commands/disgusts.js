...
module.exports.config = {
  ...
  description: "disgus the user tagged",
  commandCategory: "general",
  usages: "disgus [Tag someone you need to disgus]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/disgust').then(res => {
