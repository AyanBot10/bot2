...
module.exports.config = {
  ...
  description: "scream the user tagged",
  commandCategory: "general",
  usages: "scream [Tag someone you need to scream]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/scream').then(res => {
