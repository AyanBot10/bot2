...
module.exports.config = {
  ...
  description: "clap the user tagged",
  commandCategory: "general",
  usages: "clap [Tag someone you need to clap]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/clap').then(res => {
 ...
 let callback = function () {
        ...
        api.sendMessage({
						        body: "clapping for you  " + tag + "☺️\n\nbht acha kam kiye ho beta~",
                                          mentions: [{
          tag: tag,
