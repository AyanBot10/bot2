...
module.exports.config = {
  ...
  description: "stare the user tagged",
  commandCategory: "general",
  usages: "stare [Tag someone you need to stare]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/stare').then(res => {
