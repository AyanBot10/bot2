...
module.exports.config = {
  ...
  description: "thinking the user tagged",
  commandCategory: "general",
  usages: "thinking [Tag someone you need to thinking]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/thinking').then(res => {
