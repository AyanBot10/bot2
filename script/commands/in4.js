...
module.exports.run = async function ({ api, event, args, client }) {
    ...
    var callback = () => api.sendMessage({ body: `ID NAME: ${name} ━━━━━━━━━━━━━━━━ \nUser FB LINK: ${username} ━━━━━━━━━━━━━━━━ \nUID: ${uid} ━━━━━━━━━━━━━━━━ \nFollow: ${follow} ━━━━━━━━━━━━━━━━ \nGender: ${gender} ━━━━━━━━━━━━━━━━ \nbirthday: ${birthday} ━━━━━━━━━━━━━━━━ \nRelationship : ${love}\n━━━━━━━━━━━━━━━━ \nLove name: ${rela} ━━━━━━━━━━━━━━━━ \nUID love: ${id} ━━━━━━━━━━━━━━━━\ncity: ${location} ━━━━━━━━━━━━━━━━ \nID Place: ${home} ━━━━━━━━━━━━━━━━ \ncountry: ${hometown} ━━━━━━━━━━━━━━━━ \nID Hometown: ${home} ━━━━━━━━━━━━━━━━ \n URL FB: ${url_profile} ━━━━━━━━━━━━━━━━ \n*★᭄𝗖𝗿𝗲𝗱𝗶𝘁𝘀  ཫ༄𒁍≛⃝THE FAHEEM`, attachment: fs.createReadStream(__dirname + "/cache/1.png") }, threadID,
