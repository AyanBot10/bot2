...
module.exports.config = {
  ...
  description: "pat the user tagged",
  commandCategory: "general",
  usages: "pat [Tag someone you need to pat]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/pat').then(res => {
