...
module.exports.config = {
  ...
  description: "drunk the user tagged",
  commandCategory: "general",
  usages: "drunk [Tag someone you need to drunk]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/drunk').then(res => {
