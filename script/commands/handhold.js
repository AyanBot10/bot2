...
module.exports.config = {
  ...
  description: "handhold the user tagged",
  commandCategory: "general",
  usages: "handhold [Tag someone you need to handhold]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/handhold').then(res => {
