...
module.exports.config = {
  ...
  description: "like the user tagged",
  commandCategory: "general",
  usages: "like [Tag someone you need to like]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/like').then(res => {
