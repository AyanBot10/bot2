...
module.exports.config = {
  ...
  description: "shrug the user tagged",
  commandCategory: "general",
  usages: "shrug [Tag someone you need to shrug]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/shrug').then(res => {
