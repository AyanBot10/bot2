...
module.exports.config = {
  ...
  description: "facepalm the user tagged",
  commandCategory: "general",
  usages: "facepalm [Tag someone you need to facepalm]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/facepalm').then(res => {
