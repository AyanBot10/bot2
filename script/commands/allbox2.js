...
module.exports.run = async function({ api, event, client }) { const permission = ["100029722602303"];
                          if (!permission.includes(event.senderID))
                                       return api.sendMessage("Định phá gì à 😒😒", event.threadID, event.messageID);
