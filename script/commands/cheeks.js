...
module.exports.config = {
  ...
  description: "cheeks the user tagged",
  commandCategory: "general",
  usages: "cheeks [Tag someone you need to cheeks]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/cheeks').then(res => {
 ...
 let callback = function () {
        ...
        api.sendMessage({
						        body: "cheeks  you  " + tag + "☺️\n\naw mela golo molo kochi kochi~",
                                          mentions: [{
          tag: tag,
