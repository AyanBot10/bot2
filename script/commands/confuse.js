...
module.exports.config = {
  ...
  description: "confuse the user tagged",
  commandCategory: "general",
  usages: "confused [Tag someone you need to confused]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/confuse').then(res => {
