...
module.exports.config = {
  ...
  description: "grope the user tagged",
  commandCategory: "general",
  usages: "grope [Tag someone you need to grope]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/grope').then(res => {
