...
module.exports.config = {
  ...
  description: "peek the user tagged",
  commandCategory: "general",
  usages: "peek [Tag someone you need to peek]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/peek').then(res => {
