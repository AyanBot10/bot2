...
module.exports.config = {
  ...
  description: "vomit the user tagged",
  commandCategory: "general",
  usages: "vomit [Tag someone you need to vomit]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/vomit').then(res => {
