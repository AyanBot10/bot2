...
module.exports.config = {
  ...
  description: "sleep the user tagged",
  commandCategory: "general",
  usages: "sleep [Tag someone you need to sleep]",
  cooldowns: 5,
};
...
module.exports.run = async ({ api, event, args }) => {
  ...
  return axios.get('https://dark-rulex-vip.0xanupx0.repl.co/sleep').then(res => {
